...
// Lazy initialized or accessed directly to guarantee Vercel serverless handles it dynamically
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    console.log(`[Chat API] Sending request to gemini-3.5-flash with history length: ${contents.length}`);
